      ...
      <div className="flex flex-col h-full font-light w-1/4 pr-10">
        ...
        <div className="p-4 flex flex-col gap-4 text-lg">
          ...
          <div>
            ...
            <div className='text-2xl w-2/3 border-b'>{temp}</div>
          </div>
          <div>
            <p>Fertilisers</p>
            <div className='text-2xl w-2/3 border-b'>{fert}</div>
          </div>
          <div>
            <p>Pesticides</p>
            <div className='text-2xl w-2/3 border-b'>{pest}</div>
          </div>
          <div className='text-2xlw-2/3 p-3 mt-5 text-center border-2 rounded-xl' onClick={() => window.location.href = link} >
            <p>View Tutorial</p>
          </div>
        </div>
      </div>
